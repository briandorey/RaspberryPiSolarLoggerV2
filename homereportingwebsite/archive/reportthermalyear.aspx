...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            objConn.Open();
            System.Data.SqlClient.SqlDataAdapter daTax = new System.Data.SqlClient.SqlDataAdapter("SELECT MAX(maxwaterpanel) as MAXTemp, CONVERT(date, EntryDate) as EntryDate FROM FullArchive GROUP BY CONVERT(date, EntryDate) order by CONVERT(date, EntryDate)", objConn);
