...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            objConn.Open();
            System.Data.SqlClient.SqlDataAdapter daTax = new System.Data.SqlClient.SqlDataAdapter("SELECT MAX(solarc) as MAXTemp, CONVERT(date, eDate) as eDate FROM HomeLogGeneral GROUP BY CONVERT(date, eDate) order by CONVERT(date, eDate)", objConn);
