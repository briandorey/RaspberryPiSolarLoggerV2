...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
 ...
 <script type="text/javascript" src="https://www.google.com/jsapi"></script>
  ...
  <ItemTemplate>
      ...
      ['<%# DataBinder.Eval(Container.DataItem, "DateYear") %>.<%# DataBinder.Eval(Container.DataItem, "DateMonth") %>', <%# DataBinder.Eval(Container.DataItem, "watertop") %>,  <%# DataBinder.Eval(Container.DataItem, "waterpanel") %>, <%# DataBinder.Eval(Container.DataItem, "hometemp1") %>],
  </ItemTemplate>
</asp:Repeater>
            ]);
